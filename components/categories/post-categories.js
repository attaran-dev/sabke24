  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۱</div>
      </Link>
      <Link
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۲</div>
      </Link>
      <Link
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۳</div>
      </Link>
      <Link
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۴</div>
      </Link>
      <Link
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۵</div>
      </Link>
      <Link
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۶</div>
      </Link>
      <Link
        href="/category/sport"
        id="sport"
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۷</div>
      </Link>
      <Link
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۸</div>
      </Link>
      <Link
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۹</div>
      </Link>
      <Link
        href="/category/sleep"
        id="sleep"
      ...
      <div className="absolute -bottom-6 right-4 text-4xl w-10 h-10 bg-white rounded-full">۱۰</div>
      </Link>
    </div>
  );
}
